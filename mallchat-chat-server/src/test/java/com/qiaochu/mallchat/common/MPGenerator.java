...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.qiaochu.mallchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("qiaochuadmin");
        dataSourceConfig.setUrl("jdbc:mysql://110.40.175.18:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}